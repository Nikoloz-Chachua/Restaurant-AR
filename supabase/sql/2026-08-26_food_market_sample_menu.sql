...
WITH dishes(category_en, name_en, name_ka, name_ru, description_en, description_ka, description_ru, price, thumbnail_url, sort_order) AS (VALUES
  ...
  ('Starters', 'Elarji Balls with Bazhe Sauce', 'ელარჯის ბურთები ბაჟეს სოუსში', 'Шарики эларджи с соусом баже',
  ...
  ('Starters', 'Chicken Balls in Shkmeruli Sauce', 'ქათმის ბურთები შქმერულ სოუსში', 'Куриные шарики в соусе шкмерули',
  ...
  ('Burgers', 'Smash Burger', 'სმეშ ბურგერი', 'Смэш-бургер',
  ...
  ('Sushi', 'Shrimp Maki', 'კრევეტის მაკი', 'Маки с креветкой',
  ...
  ('Wine', 'Danieli, Saperavi', 'დანიელი, საფერავი', 'Даниели, Саперави',
  ...
  ('Wine', 'Chelti, Saperavi Rosé', 'ჩელთი, საფერავი როზე', 'Челти, Саперави Розе',
